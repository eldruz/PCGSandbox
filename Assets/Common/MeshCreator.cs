...
namespace PapaPoncho
{
    public static class MeshCreator
    {
        ...
        /// Generating a cylinder facing any direction
        /// </summary>
        ...
        public static Mesh Cylinder(Vector3 p1, Vector3 p2, float r1, float r2, int sub = 3, bool bottom = false, bool top = false)
        {
            Mesh mesh = new Mesh()
            {
                name = "Cylinder mesh",
        ...
        [System.Obsolete("Use MeshCreator.Cylinder instead.")]
        public static Mesh CylinderYAxis(Vector3 start, Vector3 end, float startRadius, float endRadius, int lengthSegments = 8, int heightSegments = 1, bool bottom = false, bool top = false)
        {
            Mesh mesh = new Mesh()
            {
                name = "Cylinder mesh",
